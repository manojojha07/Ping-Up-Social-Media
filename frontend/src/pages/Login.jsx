     ...
     <img src={assets.bgImage} alt=""
      ...
      <div className="flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40">
        ...
        <div className="">
            ...
            from-indigo-950 to-indigo-800 bg-clip-text text-transparent'>More then just firrends truly on pingup</h1>
          <p className="text-xl md:text-3xl text-indigo-900 max-w72 md:max-w-md">
