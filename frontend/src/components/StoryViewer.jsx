import { Badge, BadgeCheck, SwatchBook, X } from 'lucide-react'
...
const StoryViewer = ({viewStory, setViewStory}) => {
    ...
    const renderContent = () => {
        switch (viewStory.media_type) {
            ...
            case 'video':
                return (
                    <video onEnded={()=> setViewStory(null)} src={viewStory.media_url} alt=""
  ...
  return (
    ...
    style={{backgroundColor : viewStory.media_type === 'text'
     ? viewStory.background_color : "#000000"}}>
      ...
      sm:p-4 sm:px-8 backdrop-blur-2xl rounded-lg bg-black/50">
