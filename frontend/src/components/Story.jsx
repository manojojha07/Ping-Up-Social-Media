...
const Story = () => {
  ...
  return (
    <div className='w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl no-scrollbar px-4 overflow-x-auto'>
    ...
    mb-3">
            ...
            <p className='text-sm font-medium text-shadow-slate-700 text-center'> Create Story</p>
          </div>
        </div>
        {/* story cards */}
        ...
        hover:from-indigo-700 hover:to-purple-800 active:scale-95`}>
            <img src={story.user.profile_picture} alt=""
              className='absolute size-8 top-3 left-3 z-10 rounded-full ring ring-gray-1000 shadow' />
